...
# ex1Summary <- unname(t(sapply(1:REPS,function(ii) output(sim1[,ii]))) %>% apply(2,mean))
# res1 <- data.frame(prop = propChange, intv = 'none', baseline = 'ex1', cum_I_r = ex1Summary[1], cum_I_sp = ex1Summary[2])
# 
# ex2Summary <- unname(t(sapply(1:REPS,function(ii) output(sim2[,ii]))) %>% apply(2,mean))
# res2 <- data.frame(prop = propChange, intv = 'none', baseline = 'ex2', cum_I_r = ex2Summary[1], cum_I_sp = ex2Summary[2])
