...
The Euler-multinomial approximation was implemented in R version 3.1.5 and uses the `pomp` package (version 1.19). A single update is accomplished using the following function:
